...
void processFeed(void) {
    ...
    while( (char)keyboard != 'q' && (char)keyboard != 27 ){
        ...
        //test to see if we detect the white pixels in the binary frame
        if(debug == 1) {
            for(int y = 0; y < fgMaskMOG2.rows; y++) {
                for(int x = 0; x < fgMaskMOG2.cols; x++) {
                    if(fgMaskMOG2.at<unsigned char>(x,y) == 255) cout << fgMaskMOG2.at<char>(x,y) << endl;
                }
            }
        }
